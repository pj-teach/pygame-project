...
py.mixer.init()
coin_sound = py.mixer.Sound("../GitPygameProject/coins.mp3")
...
panel = 150
coins = 0
coinImg = py.image.load('../GitPygameProject/chest.png')
coinImg = py.transform.scale(coinImg,(40,40))
pumpkin = py.image.load('../GitPygameProject/pumpkin.jpg')
pumpkin = py.transform.scale(pumpkin,(60,60))
obstacleImg = py.image.load('../GitPygameProject/obstacle1.png')
obstacleImg = py.transform.scale(obstacleImg,(60,60))
bgImg = py.image.load('../GitPygameProject/bg1.png')
bgImg = py.transform.scale(bgImg,(width, height))
img = py.image.load('../GitPygameProject/dog.png')
...
def draw_panel(screen, coins):
    font = py.font.SysFont(None, 30)   # type: ignore
    # panel background
